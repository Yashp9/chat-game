...
// import ChatBg from "../assets/images/ester.jpg";
...
// const ChatPreviewBox = ({ id, onCheck }) => {
//   return (
...
// const SettingsPage = () => {
//   const { theme, setTheme,setBgImage } = useThemeStore();
...
//       >
//         {[1, 2, 3, 4].map((id) => (
//           <ChatPreviewBox key={id} id={id} onCheck={handleBgImage} />
//         ))}
//       </motion.div>
//     </div>
//   );
...
// import ChatBg_2 from "../assets/images/bgImg/dark.jpg";
